      ...
      <div style={styles.headerRow}>
        ...
        <div style={styles.statusBox}>
          ...
          <span>
            ...
            {summary.health === "warning" && `${summary.warningCount} warning(s)`}
        ...
        {summary.sourceSummaries.length === 0 ? (
          ...
          <div style={styles.sourceGroupList}>
            {summary.sourceSummaries.map((source) => (
              <div key={source.sourceId} style={styles.sourceGroup}>
      ...
      <table style={styles.table}>
        ...
        <tbody>
          {outputs.map((output) => {
            ...
            return (
              <tr key={output.id}>
                <td style={styles.td}>{outputDisplayName(output, outputIndex)}</td>
  ...
  return (
    <section style={styles.outputSection}>
      ...
      {outputs.map((soca) => {
        ...
        return (
          <div key={soca.id} style={styles.socaReportBlock}>
                  ...
                  .map((socket) => {
                    ...
                    return (
                      <tr key={socket.id}>
                        ...
                        <td style={styles.td}>{formatWatts(outputWatts(socket))}</td>
